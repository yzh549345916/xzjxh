...
{
    public class 城镇预报120小时个人评分ViewModel : INotifyPropertyChanged
    {
        private float allJQ;
        private float dWJQ;
        private float dWPF;
        ...
        public 城镇预报120小时个人评分ViewModel()
        {

        }
        public 城镇预报120小时个人评分ViewModel(string myname, string mypeopleID, string mypeopleName, short mypM, short myzBCS,
