...
{
    public class 旗县乡镇精细化预报准确率ViewModel : INotifyPropertyChanged
    {
        private string _旗县;
        ...
        public 旗县乡镇精细化预报准确率ViewModel(string my旗县, float mysJ24TmaxZQL, float mysJ24TminZQL, float mysJ24QYZQL,
