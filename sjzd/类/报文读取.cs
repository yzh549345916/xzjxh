...
namespace sjzd
{
    internal class 报文读取
    {
        ...
        public string Sjyb(string YBDate, string strTime)
        {
            ...
            try
            {
                ...
                if (pathYB.Trim().Length > 0)
                {
                    ...
                    float[] Tmax24 = new float[intCount], Tmin24 = new float[intCount], Tmax48 = new float[intCount], Tmax72 = new float[intCount], Tmin48 = new float[intCount], Tmax96 = new float[intCount], Tmin96 = new float[intCount], Tmax120 = new float[intCount], Tmin120 = new float[intCount], Tmin72 = new float[intCount];
                    string[] StationID = new string[intCount], Rain24 = new string[intCount], Rain48 = new string[intCount], Rain96 = new string[intCount], Rain120 = new string[intCount], Rain72 = new string[intCount];
                    string[] FX24 = new string[intCount], FS24 = new string[intCount], FX48 = new string[intCount], FS48 = new string[intCount], FX96 = new string[intCount], FS96 = new string[intCount], FX120 = new string[intCount], FS120 = new string[intCount], FX72 = new string[intCount], FS72 = new string[intCount];
                    string WeatherDZ = Environment.CurrentDirectory + @"\设置文件\天气对照.txt";
                    ...
                    using (StreamReader sr = new StreamReader(pathYB, Encoding.GetEncoding("GB2312")))
                    {
                        ...
                        {
                            string[] szLS = line.Split(new[]
                            {
                                ' '
                            }, StringSplitOptions.RemoveEmptyEntries);
                            if (lineCount == 15 * k + 5)
                            {
                                StationID[k] = line.Split(new[]
                                {
                                    ' '
                    ...
                    {
                        strFH += StationID[i] + ',' + Tmin24[i] + ',' + Tmax24[i] + ',' + Rain24[i] + ',' + FX24[i] + ',' + FS24[i] + ',' + Tmin48[i] + ',' + Tmax48[i] + ',' + Rain48[i] + ',' + FX48[i] + ',' + FS48[i] + ',' + Tmin72[i] + ',' + Tmax72[i] + ',' + Rain72[i] + ',' + FX72[i] + ',' + FS72[i] + ',' + Tmin96[i] + ',' + Tmax96[i] + ',' + Rain96[i] + ',' + FX96[i] + ',' + FS96[i] + ',' + Tmin120[i] + ',' + Tmax120[i] + ',' + Rain120[i] + ',' + FX120[i] + ',' + FS120[i] + '\n';
                    }
        ...
        //读取七天预报，包括10时
        public string Sjyb7days(string YBDate, string strTime)
        {
            string strFH = "";
            string line = "";
            ...
            try
            {
                ...
                if (pathYB.Trim().Length > 0)
                {
                    ...
                    float[] Tmax24 = new float[intCount], Tmin24 = new float[intCount], Tmax48 = new float[intCount], Tmax72 = new float[intCount], Tmin48 = new float[intCount], Tmax96 = new float[intCount], Tmin96 = new float[intCount], Tmax120 = new float[intCount], Tmin120 = new float[intCount], Tmin72 = new float[intCount], Tmax144 = new float[intCount], Tmin144 = new float[intCount], Tmax168 = new float[intCount], Tmin168 = new float[intCount];
                    string[] StationID = new string[intCount], Rain24 = new string[intCount], Rain48 = new string[intCount], Rain96 = new string[intCount], Rain120 = new string[intCount], Rain72 = new string[intCount], Rain144 = new string[intCount], Rain168 = new string[intCount];
                    string[] FX24 = new string[intCount], FS24 = new string[intCount], FX48 = new string[intCount], FS48 = new string[intCount], FX96 = new string[intCount], FS96 = new string[intCount], FX120 = new string[intCount], FS120 = new string[intCount], FX72 = new string[intCount], FS72 = new string[intCount], FX144 = new string[intCount], FS144 = new string[intCount], FX168 = new string[intCount], FS168 = new string[intCount];
                    string WeatherDZ = Environment.CurrentDirectory + @"\设置文件\天气对照.txt";
                    float WeatherLS = 0, FXLS = 0, FSLS = 0; //保存天气、风向、风速的编码临时信息，为了判断前12小时和后12小时的天气是否一致
                    string FXDZ = Environment.CurrentDirectory + @"\设置文件\风向对照.txt";
                    string FSDZ = Environment.CurrentDirectory + @"\设置文件\风速对照.txt";
                    using (StreamReader sr = new StreamReader(pathYB, Encoding.GetEncoding("GB2312")))
                    {
                        ...
                        while ((line = sr.ReadLine()) != null && k < intCount) //k代表乡镇的序号
                        {
                            ...
                            else if (lineCount == 15 * k + 16)
                            {
                                WeatherLS = Convert.ToSingle(szLS[19]);
                                FXLS = Convert.ToSingle(szLS[20]);
                                FSLS = Convert.ToSingle(szLS[21]);
                            }
                            else if (lineCount == 15 * k + 17)
                            {
                                Tmax144[k] = Convert.ToSingle(szLS[11]);
                                Tmin144[k] = Convert.ToSingle(szLS[12]);
                                float WeatherLS1 = Convert.ToSingle(szLS[19]), FXLS1 = Convert.ToSingle(szLS[20]), FSLS1 = Convert.ToSingle(szLS[21]);
                                if (WeatherLS == WeatherLS1)
                                {
                                    using (StreamReader sr1 = new StreamReader(WeatherDZ, Encoding.GetEncoding("GB2312")))
                            ...
                            else if (lineCount == 15 * k + 18)
                            {
                                WeatherLS = Convert.ToSingle(szLS[19]);
                                FXLS = Convert.ToSingle(szLS[20]);
                                FSLS = Convert.ToSingle(szLS[21]);
                            }
                            else if (lineCount == 15 * k + 19)
                            {
                                Tmax168[k] = Convert.ToSingle(szLS[11]);
                                Tmin168[k] = Convert.ToSingle(szLS[12]);
                                float WeatherLS1 = Convert.ToSingle(szLS[19]), FXLS1 = Convert.ToSingle(szLS[20]), FSLS1 = Convert.ToSingle(szLS[21]);
                                if (WeatherLS == WeatherLS1)
                                {
                                    using (StreamReader sr1 = new StreamReader(WeatherDZ, Encoding.GetEncoding("GB2312")))
                    ...
                    for (int i = 0; i < intCount; i++)
                    {
                        strFH += StationID[i] + ',' + Tmin24[i] + ',' + Tmax24[i] + ',' + Rain24[i] + ',' + FX24[i] + ',' + FS24[i] + ',' + Tmin48[i] + ',' + Tmax48[i] + ',' + Rain48[i] + ',' + FX48[i] + ',' + FS48[i] + ',' + Tmin72[i] + ',' + Tmax72[i] + ',' + Rain72[i] + ',' + FX72[i] + ',' + FS72[i] + ',' + Tmin96[i] + ',' + Tmax96[i] + ',' + Rain96[i] + ',' + FX96[i] + ',' + FS96[i] + ',' + Tmin120[i] + ',' + Tmax120[i] + ',' + Rain120[i] + ',' + FX120[i] + ',' + FS120[i] + ',' + Tmin144[i] + ',' + Tmax144[i] + ',' + Rain144[i] + ',' + FX144[i] + ',' + FS144[i] + ',' + Tmin168[i] + ',' + Tmax168[i] + ',' + Rain168[i] + ',' + FX168[i] + ',' + FS168[i] + '\n';
                    }
        ...
        public string Sjyb(string YBPath)
        {
            string strFH = "";
            string line = "";
        ...
        public string DQLB(string qjPath, string BWBS, string SC, string YBDate)
        {
            if (qjPath.Length > 0 && BWBS.Length > 0)
            {
                if (SC == "08")
                {
                    DateTime dt = DateTime.ParseExact(YBDate, "yyyyMMdd", CultureInfo.CurrentCulture);
