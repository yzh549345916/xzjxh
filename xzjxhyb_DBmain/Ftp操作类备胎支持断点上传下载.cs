...
namespace ManagementProject
{
    public class FTPHelper
    {
        ...
        /// Ftp服务器ip
        /// </summary>
        public static string FtpServerIP = "172.18.142.167";// "172.18.142.167";
        /// <summary>
        /// Ftp 指定用户名
        /// </summary>
        public static string FtpUserID = "qxt";
        /// <summary>
        /// Ftp 指定用户密码
        /// </summary>
        public static string FtpPassword = "qxt123";
        ...
        public static string[] GetFilesDetailList()
        {
            ...
            try
            {
                ...
                Encoding myEncode = GetEncodingEncode(response);
                StreamReader reader = new StreamReader(response.GetResponseStream(), myEncode);
